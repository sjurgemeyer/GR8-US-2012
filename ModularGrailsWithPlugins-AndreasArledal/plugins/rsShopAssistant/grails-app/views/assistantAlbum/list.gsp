...
<body>
    ...
    <div style="margin: 1em; position: relative; clear: both;">
        <g:link action="create" style="position: absolute; left: 0;"><button>Add album</button></g:link>
    ...
    <div style="margin: 1em; clear: both;">
        <g:each in="${albums}" var="album">
            <g:render template="/shared/albumEntryTemplate" model="${[editable: true, album: album]}" />
        </g:each>
    </div>
</body>
</html>
